...
from basic_lap_time import time_delta_to_str, validate_fast_f1_Request, load_driver_laps
...
def test_load_driver_laps(mock_to_csv, mock_get_session):
    ...
    mock_laps = pd.DataFrame({
        "Driver": ["ALO", "ALO"],
        "LapTime": [pd.to_timedelta("0 days 00:01:19.104000"), pd.to_timedelta("0 days 00:01:20.050000")],
        "LapNumber": [1, 2]
    })
